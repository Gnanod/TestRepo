...
//        double grossAmount = Double.parseDouble(jobCloseDto.getServiceTotal()) + Double.parseDouble(jobCloseDto.getItemTotal());
        ...
        try {
            ...
            jasperPrint = JasperFillManager.fillReport(System.getProperty("user.dir") + "/webapps/BackEnd-1.0-SNAPSHOT/WEB-INF/classes/UpdatefinalInvoice.jasper", parameters, new JREmptyDataSource());
