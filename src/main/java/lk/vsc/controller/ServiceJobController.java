...
//        /* Using compiled version(.jasper) of Jasper report to generate PDF */
        ...
        try {
            ...
            jasperPrint = JasperFillManager.fillReport(System.getProperty("user.dir") + "/webapps/BackEnd-1.0-SNAPSHOT/WEB-INF/classes/ServiceReport.jasper", parameters, new JREmptyDataSource());
