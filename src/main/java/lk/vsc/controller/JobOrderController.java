...
//                jasperPrint = JasperFillManager.fillReport(System.getProperty("user.dir") + "/BackEnd/src/main/java/lk/vsc/jasper/Blank_A4.jasper", parameters, new JREmptyDataSource());
                jasperPrint = JasperFillManager.fillReport(System.getProperty("user.dir") + "/webapps/BackEnd-1.0-SNAPSHOT/WEB-INF/classes/Blank_A4.jasper", parameters, new JREmptyDataSource());
...
//        /* Using compiled version(.jasper) of Jasper report to generate PDF */
        ...
        try {
           ...
           // jasperPrint = JasperFillManager.fillReport(FINAL_INVOICE_FILE_NAME, parameters, new JREmptyDataSource());
            ...
            jasperPrint = JasperFillManager.fillReport(System.getProperty("user.dir") + "/webapps/BackEnd-1.0-SNAPSHOT/WEB-INF/classes/FinalInvoice.jasper", parameters, new JREmptyDataSource());
