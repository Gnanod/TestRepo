...
public class InvoiceController {
    ...
    private DocumentDto printInvoice(JobCloseDTO jobCloseDto) {
        ...
        try {
            ...
            jasperPrint = JasperFillManager.fillReport(System.getProperty("user.dir") + "/webapps/BackEnd-1.0-SNAPSHOT/WEB-INF/classes/performaInvoice.jasper", parameters, new JREmptyDataSource());
