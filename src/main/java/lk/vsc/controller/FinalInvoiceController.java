...
//        /* Using compiled version(.jasper) of Jasper report to generate PDF */
    ...
    private DocumentDto printInvoiceOneThree(FinalInvoice invoice) {
        ...
        String fileName = "finalInvoice.pdf";
        //  outputFile = userHomeDirectory + File.separatorChar + "src/" + fileName;
        outputFile = userHomeDirectory + File.separatorChar + "/webapps/BackEnd-1.0-SNAPSHOT/WEB-INF/classes/" + fileName;
...
//        /* Using compiled version(.jasper) of Jasper report to generate PDF */
        ...
        try {
            ...
            //  jasperPrint = JasperFillManager.fillReport(SERVICE_REPORT_FILE_NAME, parameters, new JREmptyDataSource());
            jasperPrint = JasperFillManager.fillReport(System.getProperty("user.dir") + "/webapps/BackEnd-1.0-SNAPSHOT/WEB-INF/classes/finalInvoiceThree.jasper", parameters, new JREmptyDataSource());
...
//        /* Using compiled version(.jasper) of Jasper report to generate PDF */
        ...
        try {
            ...
            //  jasperPrint = JasperFillManager.fillReport(SERVICE_REPORT_FILE_NAME, parameters, new JREmptyDataSource());
            jasperPrint = JasperFillManager.fillReport(System.getProperty("user.dir") + "/webapps/BackEnd-1.0-SNAPSHOT/WEB-INF/classes/finalInvoiceOne.jasper", parameters, new JREmptyDataSource());
...
//        /* Using compiled version(.jasper) of Jasper report to generate PDF */
        ...
        try {
            ...
            //  jasperPrint = JasperFillManager.fillReport(SERVICE_REPORT_FILE_NAME, parameters, new JREmptyDataSource());
            jasperPrint = JasperFillManager.fillReport(System.getProperty("user.dir") + "/webapps/BackEnd-1.0-SNAPSHOT/WEB-INF/classes/finalInvoiceTwo.jasper", parameters, new JREmptyDataSource());
